...
public class BookStoreTest {
        ...
        public void addBookToProfile() {
                ...
                boolean bookDetailsVisible = driver
                                .findElement(By.xpath("//label[text()='Programming JavaScript Applications']"))
                                .isDisplayed();

                Assert.assertTrue(bookDetailsVisible, "Book details are not visible");

                wait.until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("//button[text()='Add To Your Collection']")));
                WebElement addToCollectionButton = driver
                                .findElement(By.xpath("//button[text()='Add To Your Collection']"));
